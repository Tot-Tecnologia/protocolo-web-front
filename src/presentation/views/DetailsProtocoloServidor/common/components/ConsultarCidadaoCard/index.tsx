...
import { consultarCidadaoRequestDefaultValues, consultarCidadaoRequestValidationSchema, type ConsultarCidadaoRequest } from "@/presentation/views/DetailsProtocoloServidor/common/validations/consultarCidadaoRequestValidationSchema";
